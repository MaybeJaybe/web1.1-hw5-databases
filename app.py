...
def create():
    ...
    if request.method == 'POST':
        ...
        add_plant = plants_collection.insert_one(new_plant)

        return redirect(url_for('detail', plant_id=add_plant.inserted_id))
...
def harvest(plant_id):
    ...
    add_harvest = harvests_collection.insert_one(new_harvest)
...
def edit(plant_id):
    ...
    if request.method == 'POST':
        ...
        update_plant = plants_collection.update_one(
            {
